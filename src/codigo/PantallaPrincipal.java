...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    Casilla[][] arrayCasillas = new Casilla[filas][columnas];
    /**
	...
	//A partir de aqui empiezo a construir el grid
	jPanelMapa.setLayout(new GridLayout(filas, columnas));
	for (int i = 0; i < filas; i++) {
	    for (int j = 0; j < columnas; j++) {
		Casilla boton = new Casilla(i, j);
		boton.setBorder(null);
		jPanelMapa.add(boton);
		arrayCasillas[i][j] = boton;
    ...
    private void casillaPulsada(MouseEvent e) {
	Casilla miCasilla = (Casilla) e.getComponent();
	if(inanimado != 0){
	    miCasilla.setBackground(Color.black);
	}
	else{
	    miCasilla.setBackground(null);
	}
    }
    ...
    private void initComponents() {
        ...
        jPanelMapa.setBackground(new java.awt.Color(204, 204, 255));
